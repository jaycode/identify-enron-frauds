...
# If to_np_array is True, convert to numpy array before fitting into classifier.
# Set it to false when you need to extract features in your classifier (usually within
# Pipeline or FeatureUnion)
def test_classifier(clf, dataset, feature_list, folds = 1000, to_np_array=True):
    data = featureFormat(dataset, feature_list, sort_keys = True, to_np_array=to_np_array)
